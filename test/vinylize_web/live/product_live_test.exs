defmodule VinylizeWeb.ProductLiveTest do
  use VinylizeWeb.ConnCase

  import Phoenix.LiveViewTest
  import Vinylize.CatalogFixtures

  @create_attrs %{category: 42, image: "some image", is_seasonal: true, name: "some name", pack_size: 42, price: 120.5, sku: 42}
  ...
  @invalid_attrs %{category: nil, image: nil, is_seasonal: false, name: nil, pack_size: nil, price: nil, sku: nil}
